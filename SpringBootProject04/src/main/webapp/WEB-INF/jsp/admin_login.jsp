...
#loginform{
	...
	background-image: url(../images/trainimage3.jpg);
...
#adminloginform{
	...
	padding: 80px 0;
	font-family: 'Roboto', sans-serif;
	background-image: url(../WebContent/admin_login_image.jpg);
	background-size: cover;
	background-position: center;
	background-repeat: no-repeat;
}
	...
	<div class="formWrapper">
		...
		<form class="admin_login_form">
			...
			<div class="inputFormWrapper">
				<label for="userName" style="color: #ff0000">Username
				</label>
			...
			<div id ="button_ctn"> 
				<a class="submitBtn " href="index1.html">Login</a>
